    ...
    <div class="story">
    	<div class="row">
    		<div class="box">
    			...
    			<p>With passion and dedication, we gradually grew, diversifying the range of bee products and gaining the trust of 
					customers through quality and authenticity. We are proud of our natural honey, coming from our own beehives 
					located in unpolluted areas. We are currently a leader in the local market, recognized for our pure and healthy products. 
					We continue to support organic beekeeping and promote the benefits of consuming natural honey.</p>
    	...
    	<div class="testimonial-slider">
    		<div class="testimonial-item">
    			...
    			<div class="testimonial-caption">
    				...
    				<p>Very very good, I recommend it to everyone</p>
    		...
    		<div class="testimonial-item">
    			...
    			<div class="testimonial-caption">
    				<span>Test The Quality</span>
    				<h1>Organic Premium Honey</h1>
    				<p>Healthy, delicious and cheap</p>
    			</div>
    		</div>
    	</div>
    	 <div class="control">
